...
def is_parameter_of_linear_layer(model, param):
...
if __name__ == '__main__':
    ...
    train_data_path = '/home/chenyang/train_script_lora/composition_lora/data/test_12.json'
...
'''
    for name, param in model.named_parameters():
        print(name, '||', param.shape)
        print(is_parameter_of_linear_layer(model, param))
        print()
    # for name, param in model.named_parameters():
    #    print(name, '||', param.shape)
